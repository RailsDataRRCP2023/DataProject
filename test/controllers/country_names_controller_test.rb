...
class CountryNamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country_name" do
    assert_difference("CountryName.count") do
      post country_names_url, params: { country_name: { country_code: @country_name.country_code, country_name: @country_name.country_name } }
    end
  ...
  test "should update country_name" do
    patch country_name_url(@country_name), params: { country_name: { country_code: @country_name.country_code, country_name: @country_name.country_name } }
